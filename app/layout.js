...
const header = (
  <header>
    <div className="text-center bg-[#4E4950] p-6 my-6 rounded-lg shadow-sm">
      <Link href='/'>
        <p className="text-2xl text-[#EFF0EF] text-shadow">nwanne56</p>
      </Link>

      <div className="text-white font-medium rounded-lg px-5 py-2.5 text-center inline-flex items-center  mr-2 mb-2">
...
const footer = (
  <header>
    <div className='mx-40 my-4 p-2 text-[#7D767F88] text-center border-t border-[#E2DFE0] text-xs'>
